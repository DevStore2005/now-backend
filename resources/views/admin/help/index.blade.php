        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0 pull-left">Help Pages</h6>
                    <a href="{!! route('admin.help-pages.create', ['locale' => request()->query('locale')]) !!}"
                       type="button"
                       class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add new help page</a>
                </div>
                                    ...
                                    <div class="input-group-btn action_group">
                                        <li class="action_icon">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="{{route('admin.help-pages.destroy', $page->id)}}"
                                                ...
                                                <li>
                                                    <a href="{{route('admin.help-pages.edit', ['help_page' => $page->id,'locale' => request()->query('locale')])}}"
                                                    >
