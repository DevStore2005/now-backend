    ...
    <div class="col-md-12">
	    <div class="card card-small">
	         <div class="card-header border-bottom">
	            <h6 class="m-0 pull-left">Grocery Store</h6>
	        </div>
	        <div class="card-body">
					        		...
					        		<div class="input-group-btn action_group">
									   <li class="action_icon">
										    ...
										    <ul class="dropdown-menu">
										        ...
										        <li>
										        	@if($d->status == 'ACTIVE')
										        		<a href="{{route('admin.user_update_status', ['inactive', $d->id])}}" onclick="return confirm('Are you sure? you want to inactive this service?')">Inactive</a> 
										        	@else
										        		<a href="{{route('admin.user_update_status', ['active', $d->id])}}" onclick="return confirm('Are you sure? you want to activate this service?')">Active</a> 
										        	@endif
										        </li>
										    </ul>
									   </li>
